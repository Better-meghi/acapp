...
class Player extends AcGameObject{
    ...
    shoot_fireball(tx, ty){
        ...
        new FireBall(this.playground, this, x, y, radius, vx, vy, color, speed, move_length, this.playground.height * 0.014);
    }
...
class AcGamePlayground{
    constructor(root){
        ...
        for(let i = 0;i < 5;i ++){
            this.players.push(new Player(this, this.width / 2, this.height / 2, this.height * 0.07, this.get_random_color(),this.height * 0.15, false));
        }
        this.start();
    }
